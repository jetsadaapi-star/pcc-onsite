...
const quickSteps = [
  {
    title: "เริ่มเดินทาง",
    copy: "กดจากหน้าแรก เลือกจุดเริ่มจริง เช่น บ้าน บริษัท หรือหน้างานเดิม แล้วเลือกปลายทาง",
    icon: Navigation,
    tone: "green"
  },
  {
    title: "เช็คอินเมื่อถึงหน้างาน",
    copy: "ดึง GPS เลือกโครงการ บันทึกวัตถุประสงค์ ถ่ายรูปหลักฐาน และรูปเลขไมล์ถ้ามี",
    icon: MapPinned,
    tone: "blue"
  },
  {
...
const roleCards = [
  {
    role: "พนักงานภาคสนาม",
    icon: UserRound,
    points: ["เริ่มทริปก่อนออกเดินทาง", "เช็คอิน/เช็คเอาท์ตามไซต์จริง", "เติมน้ำมันพร้อมรูปบิลและเลขไมล์"]
  },
  {
    role: "ผู้แทนขาย",
...
const detailedSteps = [
  ...
  },
  {
    ...
    summary: "ทำทุกครั้งก่อนเคลื่อนรถไปยังจุดหมาย",
    icon: Navigation,
    tone: "green",
    actions: [
  ...
  },
  {
    ...
    actions: [
      ...
      "ถ่ายหน้าปัดเลขไมล์ให้ตัวเลขตรง ไม่สะท้อนแสง และเห็นเลขครบทุกหลัก",
  ...
  },
  {
    ...
    actions: [
      ...
      "กด เช็คเอาท์ และยืนยันในหน้าต่างแจ้งเตือน",
          ...
          <section className="guide-card">
            ...
            <div className="guide-timeline">
              <div>
                ...
                <p>เปิดหน้าแรก กด “เริ่มเดินทาง” แล้วเลือกต้นทางตามจริง เช่น บ้าน บริษัท หรือหน้างานเดิม</p>
              </div>
              <div>
                <strong>2. ถึงหน้างาน</strong>
                <p>กดเช็คอินปลายทาง ดึง GPS เลือกโครงการ ใส่วัตถุประสงค์ และถ่ายรูปหลักฐาน</p>
              </div>
              <div>
                <strong>3. ออกจากหน้างาน</strong>
                <p>กดเช็คเอาท์เมื่อเสร็จงานที่จุดนั้น ถ้าจะไปอีกไซต์ให้เริ่มเดินทางใหม่ทันที</p>
              </div>
              <div>
              ...
              <div>
                <strong>5. ตรวจรายงานของฉัน</strong>
